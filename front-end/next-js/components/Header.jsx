...
export default function Header({
    ...
    const githubVisible = integrationVisibility.github === true;
    const gitlabVisible = integrationVisibility.gitlab === true;
    const hasVisibleIntegrations = githubVisible || gitlabVisible;

    const githubConnected =
        githubVisible && Boolean(integrations?.github?.connected);

    const githubUsername = githubVisible
        ? integrations?.github?.username ?? null
        : null;

    const gitlabConnected =
        gitlabVisible && Boolean(integrations?.gitlab?.connected);

    const hasConnectedVisibleIntegration =
                        ...
                        >
                            ...
                            {hasVisibleIntegrations && (
                                ...
                                >
                                    ...
                                    {hasConnectedVisibleIntegration && (
                                        <span
                                            id="integrations-dot"
